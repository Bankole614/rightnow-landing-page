    ...
    <div className="container mx-auto px-6 py-6">
      <div className="flex items-center justify-between backdrop-blur-sm bg-white/60 rounded-2xl px-6 py-4 shadow-md ring-1 ring-slate-200/50">
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-slate-600">
          <a href="#features" className="hover:text-[#1D8ADF] transition-colors">Features</a>
          <a href="#ai" className="hover:text-[#1D8ADF] transition-colors">AI Assistant</a>
          <a href="#discover" className="hover:text-[#1D8ADF] transition-colors">Find Lawyers</a>
          <a href="#pricing" className="hover:text-[#1D8ADF] transition-colors">Pricing</a>
        </nav>
