...
const CTASection: React.FC = () => (
  <section className="py-20 mx-4 lg:mx-0">
    <div className="max-w-4xl mx-auto backdrop-blur-xl bg-linear-to-br from-slate-900 via-indigo-900 to-slate-900 rounded-3xl lg:p-8 p-4 shadow-2xl relative overflow-hidden">
      <div className="relative text-center text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
          <a href="#" className="inline-flex items-center gap-2 px-10 py-4 bg-white text-primary rounded-xl font-bold shadow-2xl hover:shadow-white/20 hover:scale-105 transition-all">Start Free Trial</a>
