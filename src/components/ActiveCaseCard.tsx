    ...
    <div className="relative rounded-3xl backdrop-blur-xl bg-white/80 p-8 shadow-2xl ring-1 ring-slate-200/50 transform hover:scale-105 transition-transform duration-500">
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <div className="text-2xl font-bold mt-1 bg-linear-to-r from-indigo-600 to-cyan-500 bg-clip-text text-transparent">{title}</div>
        </div>
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="h-3 bg-linear-to-r from-slate-100 to-slate-50 rounded-full overflow-hidden shadow-inner">
            <div className="h-3 bg-linear-to-r from-indigo-500 to-cyan-400 rounded-full" style={{ width: `${progressPercent}%` }} />
          </div>
        </div>

        <div className="grid grid-cols-3 gap-4 pt-2">
          <div className="backdrop-blur-sm bg-linear-to-br from-slate-50 to-white p-3 rounded-xl border border-slate-100 text-center">
        ...
        <div className="grid grid-cols-2 gap-3 pt-2">
          <button className="px-4 py-3 bg-linear-to-r from-indigo-600 to-indigo-500 text-white rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all">
            Open Case
          </button>
      ...
      <div className="absolute -top-4 -right-4 backdrop-blur-xl bg-linear-to-br from-cyan-500 to-blue-500 text-white px-4 py-2 rounded-full text-xs font-bold shadow-xl ring-4 ring-white">✨ AI-Powered</div>
    </div>
  );
};
