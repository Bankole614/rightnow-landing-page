...
const PricingCard: React.FC<Pricing> = ({ tier, price, period, features, highlight }) => (
  <div className={`relative rounded-2xl p-8 transition-all duration-300 ${highlight ? 'bg-linear-to-br from-[#1D8ADF] to-[#283593] text-white shadow-2xl shadow-indigo-500/50 scale-105 ring-4 ring-indigo-200' : 'backdrop-blur-xl bg-white/80 ring-1 ring-slate-200/50 hover:shadow-xl hover:scale-105'}`}>
