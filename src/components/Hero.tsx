  ...
  <section className="container grid grid-cols-1 lg:grid-cols-2 gap-12 items-center pb-16 pt-44">
    <div className="space-y-8">
      ...
      <div className="max-w-sm">
        <a href="#" className="w-full inline-flex items-center justify-center gap-2 px-8 py-4 bg-linear-to-br from-[#1D8ADF] to-[#283593] text-white text-base font-semibold rounded-xl hover:scale-105 transition-all">Start Free Trial</a>
      </div>
    </div>
