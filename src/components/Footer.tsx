...
const Footer: React.FC = () => (
  <footer id="contact" className="mt-20 py-12 border-t border-slate-200">
    <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
      <div className="md:col-span-2">
        ...
        <div className="flex gap-3">
          {['twitter', 'linkedin', 'github'].map((social) => (
            <a key={social} href="#" className="w-10 h-10 rounded-xl backdrop-blur-sm bg-slate-100 hover:bg-indigo-100 flex items-center justify-center transition-all hover:scale-110">
              <span className="text-slate-600 hover:text-indigo-600">→</span>
            </a>
          ))}
        </div>
      </div>
      ...
      <div>
        ...
        <ul className="space-y-3 text-sm text-slate-600">
          ...
          <li><a href="#ai" className="hover:text-indigo-600 transition-colors">AI Assistant</a></li>
    ...
    <div className="max-w-6xl mx-auto mt-12 pt-8 border-t border-slate-200 flex flex-col md:flex-row justify-between items-center gap-4">
      ...
      <div className="flex items-center gap-6 text-sm text-slate-500">
        <a href="#" className="hover:text-indigo-600 transition-colors">hello@rightnow.app</a>
        <span>•</span>
